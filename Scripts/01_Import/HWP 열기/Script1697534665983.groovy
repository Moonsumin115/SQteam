...
'계정 입력창'
WebUI.setText(findTestObject('Object Repository/Page_/계정 입력'), 'hsignTest001@tech-mail.net')

'패스워드입력창'
WebUI.setEncryptedText(findTestObject('Object Repository/Page_/비밀번호 입력'), 'Ltf7E4+jKv89m7DilMnSEg==')
...
'파일 선택 버튼'
WebUI.uploadFileWithDragAndDrop(findTestObject('Page_/파일 선택'), 'C:\\download\\sample_pdf.pdf')
